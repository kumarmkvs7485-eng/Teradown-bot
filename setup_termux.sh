...
# NOTE: DO NOT run "pip install --upgrade pip" on Termux — it breaks
# the system pip. Install packages directly instead.
...
UPI_NAME=Your Name
ENVEOF
    warn ".env created! Edit it now before starting:"
    echo ""
    echo -e "  ${BOLD}Run:${NC}  nano .env"
    echo "  Fill in: BOT_TOKEN, ADMIN_IDS, UPI_ID, UPI_NAME"
    echo ""
else
